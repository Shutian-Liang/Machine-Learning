...
optimizer = torch.optim.Adam(model.parameters(),
                ...
                weight_decay=0,
                amsgrad=False)
scheduler = exponential_decay(initial_learning_rate=0.001, decay_rate=0.9, decay_epochs=5) # TODO: You can change this in Part 3 Step 2, for faster and better convergence.
